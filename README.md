...
To share it with others, deploy to [Railway](https://railway.app) or [Render](https://render.com) (both have free tiers):

1. Push this repo to GitHub
2. Connect the repo in Railway/Render
3. Add `ANTHROPIC_API_KEY` as an environment variable in the dashboard
4. Deploy — they'll run `npm start` automatically
